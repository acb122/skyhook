(function (global, factory) {
    ...
    (global = global || self, factory((global.rednax = global.rednax || {}, global.rednax.core = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.dndCore));
}(this, (function (exports, core, rxjs, operators, dndCore) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DRAG_DROP_BACKEND = new core.InjectionToken('dnd-core compatible backend');
    /** The injection token for the dnd-core compatible backend's options. */
    var DRAG_DROP_BACKEND_OPTIONS = new core.InjectionToken('options for dnd-core compatible backend');
    /** The injection token for the dnd-core compatible backend currently in use. */
    var DRAG_DROP_BACKEND_DEBUG_MODE = new core.InjectionToken('should dnd-core run in debug mode?');
    /** The injection token for the dnd-core DragDropManager */
    var DRAG_DROP_MANAGER = new core.InjectionToken('dnd-core DragDropManager');
    /** The injection token for the dnd-core compatible backend currently in use. */
    var DRAG_DROP_GLOBAL_CONTEXT = new core.InjectionToken('dnd-core context');
    ...
    var SkyhookDndService = /** @class */ (function () {
        ...
        SkyhookDndService.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [DRAG_DROP_MANAGER,] }] },
            { type: core.NgZone }
        ]; };
    ...
    var DropTargetDirective = /** @class */ (function (_super) {
        ...
        DropTargetDirective.propDecorators = {
            dropTarget: [{ type: core.Input, args: ['dropTarget',] }],
            dropTargetTypes: [{ type: core.Input, args: ['dropTargetTypes',] }],
            dropTargetType: [{ type: core.Input, args: ['dropTargetType',] }]
        };
    ...
    var DragSourceDirective = /** @class */ (function (_super) {
        ...
        DragSourceDirective.propDecorators = {
            dragSource: [{ type: core.Input, args: ['dragSource',] }],
            dragSourceType: [{ type: core.Input, args: ['dragSourceType',] }],
            dragSourceOptions: [{ type: core.Input, args: ['dragSourceOptions',] }],
            noHTML5Preview: [{ type: core.Input, args: ['noHTML5Preview',] }]
        };
    ...
    var DragPreviewDirective = /** @class */ (function (_super) {
        ...
        DragPreviewDirective.propDecorators = {
            dragPreview: [{ type: core.Input, args: ['dragPreview',] }],
            dragPreviewOptions: [{ type: core.Input, args: ['dragPreviewOptions',] }]
        };
    ...
    function managerFactory(backendFactory, zone, context, backendOptions, debugMode) {
        ...
        return zone.runOutsideAngular(function () {
            return dndCore.createDragDropManager(backendFactory, context, backendOptions, debugMode);
        });
    }
    /** @ignore */
    ...
    exports.ɵa = managerFactory;
    exports.ɵb = getGlobalContext;
    exports.ɵc = DRAG_DROP_BACKEND_OPTIONS;
    exports.ɵd = DRAG_DROP_BACKEND_DEBUG_MODE;
    exports.ɵe = DRAG_DROP_GLOBAL_CONTEXT;
