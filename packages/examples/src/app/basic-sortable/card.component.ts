...
export class CardComponent implements OnDestroy {
    ...
    @ContentChild(CardInnerDirective, { static: false, read: TemplateRef })
    cardInnerTemplate;
    ...
    opacity$ = this.cardSource.listen((monitor) =>
        monitor.isDragging() ? 0.2 : 1
    );

    constructor(private elRef: ElementRef, private dnd: SkyhookDndService) {}
