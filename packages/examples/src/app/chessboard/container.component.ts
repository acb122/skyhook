...
@Component({
    ...
    template: `
        ...
        <p>Welcome to <code>@rednax-skyhook</code>.</p>
        <p>
            This is a re-implementation of the original, classic
            <a
                href="http://react-dnd.github.io/react-dnd/examples-chessboard-tutorial-app.html"
                >react-dnd demo</a
            >.
        </p>
        <p>
            ...
            <a
                href="https://cormacrelf.github.io/rednax-skyhook/additional-documentation/chess-tutorial.html"
                >follow along</a
            >
