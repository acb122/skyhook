import { InjectionToken, NgZone, ɵɵinject, ɵɵdefineInjectable, ɵsetClassMetadata, Injectable, Inject, ɵɵdirectiveInject, ElementRef, ɵɵdefineDirective, ɵɵNgOnChangesFeature, Directive, ɵɵInheritDefinitionFeature, ɵɵgetInheritedFactory, Input, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';
...
SkyhookDndService.ɵfac = function SkyhookDndService_Factory(t) { return new (t || SkyhookDndService)(ɵɵinject(DRAG_DROP_MANAGER), ɵɵinject(NgZone)); };
SkyhookDndService.ɵprov = ɵɵdefineInjectable({ token: SkyhookDndService, factory: SkyhookDndService.ɵfac });
/*@__PURE__*/ (function () { ɵsetClassMetadata(SkyhookDndService, [{
        type: Injectable
...
DndDirective.ɵfac = function DndDirective_Factory(t) { return new (t || DndDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone)); };
DndDirective.ɵdir = ɵɵdefineDirective({ type: DndDirective, selectors: [["", "abstractDndDirective", ""]], features: [ɵɵNgOnChangesFeature] });
/*@__PURE__*/ (function () { ɵsetClassMetadata(DndDirective, [{
        type: Directive,
        args: [{
...
DropTargetDirective.ɵdir = ɵɵdefineDirective({ type: DropTargetDirective, selectors: [["", "dropTarget", ""]], inputs: { dropTarget: "dropTarget", dropTargetTypes: "dropTargetTypes", dropTargetType: "dropTargetType" }, features: [ɵɵInheritDefinitionFeature, ɵɵNgOnChangesFeature] });
const ɵDropTargetDirective_BaseFactory = /*@__PURE__*/ ɵɵgetInheritedFactory(DropTargetDirective);
/*@__PURE__*/ (function () { ɵsetClassMetadata(DropTargetDirective, [{
        type: Directive,
        args: [{
                selector: '[dropTarget]'
            }]
...
DragSourceDirective.ɵdir = ɵɵdefineDirective({ type: DragSourceDirective, selectors: [["", "dragSource", ""]], inputs: { dragSource: "dragSource", dragSourceType: "dragSourceType", dragSourceOptions: "dragSourceOptions", noHTML5Preview: "noHTML5Preview" }, features: [ɵɵInheritDefinitionFeature, ɵɵNgOnChangesFeature] });
const ɵDragSourceDirective_BaseFactory = /*@__PURE__*/ ɵɵgetInheritedFactory(DragSourceDirective);
/*@__PURE__*/ (function () { ɵsetClassMetadata(DragSourceDirective, [{
        type: Directive,
        args: [{
                selector: '[dragSource]'
            }]
...
DragPreviewDirective.ɵdir = ɵɵdefineDirective({ type: DragPreviewDirective, selectors: [["", "dragPreview", ""]], inputs: { dragPreview: "dragPreview", dragPreviewOptions: "dragPreviewOptions" }, features: [ɵɵInheritDefinitionFeature, ɵɵNgOnChangesFeature] });
const ɵDragPreviewDirective_BaseFactory = /*@__PURE__*/ ɵɵgetInheritedFactory(DragPreviewDirective);
/*@__PURE__*/ (function () { ɵsetClassMetadata(DragPreviewDirective, [{
        type: Directive,
        args: [{
...
SkyhookDndModule.ɵmod = ɵɵdefineNgModule({ type: SkyhookDndModule });
SkyhookDndModule.ɵinj = ɵɵdefineInjector({ factory: function SkyhookDndModule_Factory(t) { return new (t || SkyhookDndModule)(); } });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(SkyhookDndModule, { declarations: [DndDirective,
        DragSourceDirective,
        DropTargetDirective,
        ...
        DropTargetDirective,
        DragPreviewDirective] }); })();
/*@__PURE__*/ (function () { ɵsetClassMetadata(SkyhookDndModule, [{
        type: NgModule,
        args: [{
...
export { DRAG_DROP_BACKEND, DRAG_DROP_MANAGER, DndDirective, DragPreviewDirective, DragSourceDirective, DropTargetDirective, SkyhookDndModule, SkyhookDndService };
