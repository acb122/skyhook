 ...
 */
export interface DropTarget<Item = {}, DropResult = {}> extends ConnectionBase<DropTargetMonitor<Item, DropResult>> {
 ...
 */
export interface DragSource<Item, DropResult = {}> extends ConnectionBase<DragSourceMonitor<Item, DropResult>> {
